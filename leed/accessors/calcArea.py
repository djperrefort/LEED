...
class CalcArea(Base):
    ...
    def _continuumArea(self, continuum: pd.Series) -> float:
    ...
    def area(self, continuum: pd.Series) -> float:
        ...
        Returns:
            The adrea of the feature in units of wavelength squared
        """

        return self._continuumArea(continuum) - self._fluxArea()
